...
public class ModularFeatureListRow implements FeatureListRow, ModularDataModel {
  ...
  public ModularFeatureListRow(@Nonnull ModularFeatureList flist) {
    ...
    if (!raws.isEmpty()) {
      ...
      set(FeatureShapeIonMobilityRetentionTimeType.class, getFeaturesProperty());
      set(FeatureShapeIonMobilityRetentionTimeHeatMapType.class, getFeaturesProperty());
      set(FeatureShapeMobilogramType.class, getFeaturesProperty());
