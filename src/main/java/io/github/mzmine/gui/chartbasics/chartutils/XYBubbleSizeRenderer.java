 ...
 *
 * -------------------- XYCircleRenderer.java -------------------- (C) Copyright 2006-2017, by
 ...
 * ParamChecks (DG); 20-Feb-2017 : Add update for crosshairs (DG); 09-Feb-2018 : fixed pixel circle
...
import io.github.mzmine.modules.visualization.kendrickmassplot.KendrickMassPlotDataset;

/**
 * A renderer that represents data from an {@link XYZDataset} by drawing a circle at each (x,
 */
public class XYBubbleSizeRenderer extends AbstractXYItemRenderer
  ...
  public void drawItem(Graphics2D g2, XYItemRendererState state, Rectangle2D dataArea,
    ...
    if (dataset instanceof KendrickMassPlotDataset) {
      z = ((KendrickMassPlotDataset) dataset).getZValue(series, item);
      double[] bubbleSizeValues = ((KendrickMassPlotDataset) dataset).getBubbleSizeValues();
      ...
      bubbleSize = scaleBubbeSize(minBubbleSize, maxBubbleSize,
          ((KendrickMassPlotDataset) dataset).getBubbleSize(item));
    }
  ...
  public boolean equals(Object obj) {
    ...
    if (!(obj instanceof XYBubbleSizeRenderer)) {
      return false;
    }
    XYBubbleSizeRenderer that = (XYBubbleSizeRenderer) obj;
  ...
  public Object clone() throws CloneNotSupportedException {
    XYBubbleSizeRenderer clone = (XYBubbleSizeRenderer) super.clone();
