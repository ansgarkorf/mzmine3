...
public class LipidTools {
	...
	/**
	 * This method reads out the number of C atoms containing in all radyl chains of
	 * a lipid annotation
	 */
	...
	public int getNumberOfDB(String lipidAnnotation) {
		...
		if (indexFirstNumber == indexLastNumber) {
			numberOfDoubleBonds = Integer.parseInt(String.valueOf(lipidAnnotation.charAt(indexFirstNumber)));
		} else {
			numberOfDoubleBonds = Integer.parseInt(String.valueOf(lipidAnnotation.charAt(indexFirstNumber))
					+ String.valueOf(lipidAnnotation.charAt(indexLastNumber)));
		}
	...
	/**
	 * This method reads out the sum formula of class specific MS/MS fragment that
	 * also contains a fatty acid
	 */
	...
	/**
	 * This method reads out the sum formula of class specific MS/MS fragment which
	 * need be substracted from the exact mass
	 */
