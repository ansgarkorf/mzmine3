...
/**
 * This enum contains all lipid classes. Each enum has information on: name,
 * abbreviation, LipidCoreClass, LipidMainClass, lipid backbone sum formula,
 * number of acyl chains, number of alkychains, class specific positive
 * fragments and class specific negative fragments
 * 
...
public enum LipidClasses {
	...
	// Glycerolipids
	MONOACYLGLYCEROLS("Monoacylglycerols", "MG", LipidCoreClasses.GLYCEROLIPIDS, LipidMainClasses.MONORADYLGLYCEROLS,
			"C3H8O3", new LipidChainType[] { LipidChainType.ACYL_CHAIN }, new LipidFragmentationRule[] { //
					new LipidFragmentationRule(PolarityType.POSITIVE, IonizationType.AMMONIUM,
							LipidFragmentationRuleType.HEADGROUP_FRAGMENT_NL,
							LipidFragmentInformationLevelType.MOLECULAR_FORMULA, "NH3"), //
					new LipidFragmentationRule(PolarityType.POSITIVE, IonizationType.AMMONIUM,
							LipidFragmentationRuleType.HEADGROUP_FRAGMENT_NL,
							LipidFragmentInformationLevelType.MOLECULAR_FORMULA, "H5ON"), //
					new LipidFragmentationRule(PolarityType.POSITIVE, IonizationType.AMMONIUM,
							LipidFragmentationRuleType.ACYLCHAIN_MINUS_FORMULA_FRAGMENT_NL, //
							LipidFragmentInformationLevelType.CHAIN_COMPOSITION, //
							"H5ON") }), //
	MONOALKYLGLYCEROLS("Monoalkylglycerols", "MG", LipidCoreClasses.GLYCEROLIPIDS, LipidMainClasses.MONORADYLGLYCEROLS,
			"C3H8O3", new LipidChainType[] { LipidChainType.ALKYL_CHAIN }, new LipidFragmentationRule[] { //
			}), //
	DIACYLGLYCEROLS("Diacylglycerols", "DG", LipidCoreClasses.GLYCEROLIPIDS, LipidMainClasses.DIRADYLGLYCEROLS,
			"C3H8O3", new LipidChainType[] { LipidChainType.ACYL_CHAIN, LipidChainType.ACYL_CHAIN },
			new LipidFragmentationRule[] { //
					new LipidFragmentationRule(PolarityType.POSITIVE, IonizationType.AMMONIUM,
							LipidFragmentationRuleType.HEADGROUP_FRAGMENT_NL,
							LipidFragmentInformationLevelType.MOLECULAR_FORMULA, "NH3"), //
					...
					new LipidFragmentationRule(PolarityType.POSITIVE, IonizationType.AMMONIUM,
							LipidFragmentationRuleType.ACYLCHAIN_FRAGMENT_NL, //
							LipidFragmentInformationLevelType.CHAIN_COMPOSITION) }), //
	DIALKYLGLYCEROLS("Dialkylglycerols", "DG", LipidCoreClasses.GLYCEROLIPIDS, LipidMainClasses.DIRADYLGLYCEROLS,
			"C3H8O3", new LipidChainType[] { LipidChainType.ALKYL_CHAIN, LipidChainType.ALKYL_CHAIN },
			new LipidFragmentationRule[] {}), //
	ALKYLACYLGLYCEROLS("Alkylacylglycerols", "DG", LipidCoreClasses.GLYCEROLIPIDS, LipidMainClasses.DIRADYLGLYCEROLS,
			"C3H8O3", new LipidChainType[] { LipidChainType.ALKYL_CHAIN, LipidChainType.ACYL_CHAIN },
			new LipidFragmentationRule[] {}), //
	TRIACYLGLYCEROLS("Triacylglycerols", "TG", LipidCoreClasses.GLYCEROLIPIDS, LipidMainClasses.TRIRADYLGLYCEROLS,
			"C3H8O3",
			new LipidChainType[] { LipidChainType.ACYL_CHAIN, LipidChainType.ACYL_CHAIN, LipidChainType.ACYL_CHAIN },
			new LipidFragmentationRule[] { //
					...
					new LipidFragmentationRule(PolarityType.POSITIVE, IonizationType.SODIUM,
							LipidFragmentationRuleType.ACYLCHAIN_MINUS_FORMULA_FRAGMENT_NL,
							LipidFragmentInformationLevelType.MOLECULAR_FORMULA, "Na"), //
					new LipidFragmentationRule(PolarityType.POSITIVE, IonizationType.AMMONIUM,
							LipidFragmentationRuleType.HEADGROUP_FRAGMENT_NL,
							LipidFragmentInformationLevelType.MOLECULAR_FORMULA, "NH3"), //
					new LipidFragmentationRule(PolarityType.POSITIVE, IonizationType.AMMONIUM,
	...
	ALKYLDIACYLGLYCEROLS("Alkyldiacylglycerols", "TG", LipidCoreClasses.GLYCEROLIPIDS,
			...
			new LipidChainType[] { LipidChainType.ACYL_CHAIN, LipidChainType.ALKYL_CHAIN, LipidChainType.ACYL_CHAIN },
			new LipidFragmentationRule[] { //
			}), //
	DIALKYLMONOACYLGLYCEROLS("Dialkylmonoacylglycerols", "TG", LipidCoreClasses.GLYCEROLIPIDS,
			LipidMainClasses.TRIRADYLGLYCEROLS, "C3H8O3",
			new LipidChainType[] { LipidChainType.ALKYL_CHAIN, LipidChainType.ALKYL_CHAIN, LipidChainType.ACYL_CHAIN },
			new LipidFragmentationRule[] { //
			}), //
	DIACYLGLYCEROLTRIMETHYLHOMOSERIN("Diacylglyceroltrimethylhomoserin", "DGTS", LipidCoreClasses.GLYCEROLIPIDS,
			LipidMainClasses.OTHERGLYCEROLIPIDS, "C10H21O5N",
			new LipidChainType[] { LipidChainType.ACYL_CHAIN, LipidChainType.ACYL_CHAIN },
			new LipidFragmentationRule[] { //
	...
	MONOACYLGLYCEROLTRIMETHYLHOMOSERIN("Monoacylglyceroltrimethylhomoserin", "LysoDGTS", LipidCoreClasses.GLYCEROLIPIDS,
			LipidMainClasses.OTHERGLYCEROLIPIDS, "C10H21O5N", new LipidChainType[] { LipidChainType.ACYL_CHAIN },
			new LipidFragmentationRule[] { //
			}), //
	MONOGALACTOSYLDIACYLGLYCEROL("Monogalactosyldiacylglycerol", "MGDG", LipidCoreClasses.GLYCEROLIPIDS,
			LipidMainClasses.GLYCOSYLDIACYLGLYCEROLS, "C9H18O8",
			new LipidChainType[] { LipidChainType.ACYL_CHAIN, LipidChainType.ACYL_CHAIN },
			new LipidFragmentationRule[] { //
					new LipidFragmentationRule(PolarityType.POSITIVE, IonizationType.POSITIVE_HYDROGEN,
							LipidFragmentationRuleType.ACYLCHAIN_FRAGMENT_NL,
					...
					new LipidFragmentationRule(PolarityType.POSITIVE, IonizationType.POSITIVE_HYDROGEN,
							LipidFragmentationRuleType.ACYLCHAIN_MINUS_FORMULA_FRAGMENT_NL,
							LipidFragmentInformationLevelType.CHAIN_COMPOSITION, "H2O"), //
					new LipidFragmentationRule(PolarityType.POSITIVE, IonizationType.POSITIVE_HYDROGEN,
							LipidFragmentationRuleType.ACYLCHAIN_MINUS_FORMULA_FRAGMENT_NL,
							LipidFragmentInformationLevelType.CHAIN_COMPOSITION, "C6H11O6"), //
	...
	SULFOQUINOVOSYLDIACYLGLYCEROLS("Sulfoquinovosyldiacylglycerols", "SQDG", LipidCoreClasses.GLYCEROLIPIDS,
			LipidMainClasses.GLYCOSYLDIACYLGLYCEROLS, "C9H18O10S",
			new LipidChainType[] { LipidChainType.ACYL_CHAIN, LipidChainType.ACYL_CHAIN },
			new LipidFragmentationRule[] { //
					new LipidFragmentationRule(PolarityType.POSITIVE, IonizationType.POSITIVE_HYDROGEN,
							LipidFragmentationRuleType.ACYLCHAIN_FRAGMENT_NL,
					...
					new LipidFragmentationRule(PolarityType.POSITIVE, IonizationType.POSITIVE_HYDROGEN,
							LipidFragmentationRuleType.HEADGROUP_FRAGMENT_NL,
							LipidFragmentInformationLevelType.MOLECULAR_FORMULA, "C6H9O7S"), //
					new LipidFragmentationRule(PolarityType.POSITIVE, IonizationType.POSITIVE_HYDROGEN,
							LipidFragmentationRuleType.ACYLCHAIN_MINUS_FORMULA_FRAGMENT_NL,
							LipidFragmentInformationLevelType.CHAIN_COMPOSITION, "C6H9O7S"), //
	...
	SULFOQUINOVOSYLMONOACYLGLYCEROLS("Sulfoquinovosylmonoacylglycerols", "SQMG", LipidCoreClasses.GLYCEROLIPIDS,
			LipidMainClasses.GLYCOSYLMONOACYLGLYCEROLS, "C9H18O10S", new LipidChainType[] { LipidChainType.ACYL_CHAIN },
			new LipidFragmentationRule[] { //
			}), //

	// Glycerophospholipids
	DIACYLGLYCEROPHOSPHOCHOLINES("Diacylglycerophosphocholines", "PC", LipidCoreClasses.GLYCEROPHOSPHOLIPIDS,
			LipidMainClasses.PHOSPHATIDYLCHOLINE, "C8H20O6PN",
			new LipidChainType[] { LipidChainType.ACYL_CHAIN, LipidChainType.ACYL_CHAIN },
			new LipidFragmentationRule[] { //
					new LipidFragmentationRule(PolarityType.POSITIVE, IonizationType.POSITIVE_HYDROGEN,
							LipidFragmentationRuleType.HEADGROUP_FRAGMENT,
							LipidFragmentInformationLevelType.MOLECULAR_FORMULA, "C5H15NO4P"), //
					new LipidFragmentationRule(PolarityType.POSITIVE, IonizationType.POSITIVE_HYDROGEN,
							LipidFragmentationRuleType.ACYLCHAIN_FRAGMENT_NL,
							LipidFragmentInformationLevelType.CHAIN_COMPOSITION), //
					new LipidFragmentationRule(PolarityType.POSITIVE, IonizationType.POSITIVE_HYDROGEN,
							...
							LipidFragmentInformationLevelType.CHAIN_COMPOSITION, //
							"H2O") }), //
	DIALKYLGLYCEROPHOSPHOCHOLINES("Dialkylglycerophosphocholines", "PC", LipidCoreClasses.GLYCEROPHOSPHOLIPIDS,
			LipidMainClasses.PHOSPHATIDYLCHOLINE, "C8H20O6PN",
			new LipidChainType[] { LipidChainType.ALKYL_CHAIN, LipidChainType.ALKYL_CHAIN },
			new LipidFragmentationRule[] { //
			}), //
	ALKYLACYLGLYCEROPHOSPHOCHOLINES("Alkylacylglycerophosphocholines", "PC", LipidCoreClasses.GLYCEROPHOSPHOLIPIDS,
			LipidMainClasses.PHOSPHATIDYLCHOLINE, "C8H20O6PN",
			...
			new LipidFragmentationRule[] { //
					...
					new LipidFragmentationRule(PolarityType.NEGATIVE, IonizationType.FORMATE,
							LipidFragmentationRuleType.HEADGROUP_FRAGMENT_NL,
							LipidFragmentInformationLevelType.MOLECULAR_FORMULA, "C3H6O2"), //
					new LipidFragmentationRule(PolarityType.NEGATIVE, IonizationType.FORMATE,
							LipidFragmentationRuleType.ACYLCHAIN_FRAGMENT,
							LipidFragmentInformationLevelType.CHAIN_COMPOSITION), //
					...
					new LipidFragmentationRule(PolarityType.NEGATIVE, IonizationType.ACETATE,
							LipidFragmentationRuleType.ACYLCHAIN_FRAGMENT,
							LipidFragmentInformationLevelType.CHAIN_COMPOSITION) }), //
	MONOACYLGLYCEROPHOSPHOCHOLINES("Monoacylglycerophosphocholines", "LPC", LipidCoreClasses.GLYCEROPHOSPHOLIPIDS,
			LipidMainClasses.PHOSPHATIDYLCHOLINE, "C8H20O6PN", new LipidChainType[] { LipidChainType.ACYL_CHAIN },
			new LipidFragmentationRule[] { //
					new LipidFragmentationRule(PolarityType.POSITIVE, IonizationType.POSITIVE_HYDROGEN,
							LipidFragmentationRuleType.HEADGROUP_FRAGMENT,
							LipidFragmentInformationLevelType.MOLECULAR_FORMULA, "C5H15NO4P"), //
					new LipidFragmentationRule(PolarityType.POSITIVE, IonizationType.SODIUM,
							LipidFragmentationRuleType.HEADGROUP_FRAGMENT,
							LipidFragmentInformationLevelType.MOLECULAR_FORMULA, "C3H9N"), //
					new LipidFragmentationRule(PolarityType.POSITIVE, IonizationType.SODIUM,
							LipidFragmentationRuleType.ACYLCHAIN_MINUS_FORMULA_FRAGMENT_NL,
							LipidFragmentInformationLevelType.CHAIN_COMPOSITION, "H2O"), //
	...
	MONOALKYLGLYCEROPHOSPHOCHOLINES("Monoalkylglycerophosphocholines", "LPC", LipidCoreClasses.GLYCEROPHOSPHOLIPIDS,
			LipidMainClasses.PHOSPHATIDYLCHOLINE, "C8H20O6PN", new LipidChainType[] { LipidChainType.ALKYL_CHAIN },
			new LipidFragmentationRule[] { //
			}), //
	DIACYLGLYCEROPHOSPHOETHANOLAMINES("Diacylglycerophosphoethanolamines", "PE", LipidCoreClasses.GLYCEROPHOSPHOLIPIDS,
			LipidMainClasses.GLYCEROPHOSPHOETHANOLAMINES, "C5H14O6PN",
			new LipidChainType[] { LipidChainType.ACYL_CHAIN, LipidChainType.ACYL_CHAIN },
			new LipidFragmentationRule[] { //
					new LipidFragmentationRule(PolarityType.POSITIVE, IonizationType.POSITIVE_HYDROGEN,
							LipidFragmentationRuleType.HEADGROUP_FRAGMENT_NL,
							LipidFragmentInformationLevelType.MOLECULAR_FORMULA, "C2H8NO4P"), //
					new LipidFragmentationRule(PolarityType.POSITIVE, IonizationType.POSITIVE_HYDROGEN,
							LipidFragmentationRuleType.ACYLCHAIN_MINUS_FORMULA_FRAGMENT_NL, //
							LipidFragmentInformationLevelType.CHAIN_COMPOSITION, //
							"OH"), //
					new LipidFragmentationRule(PolarityType.POSITIVE, IonizationType.SODIUM,
							LipidFragmentationRuleType.HEADGROUP_FRAGMENT_NL,
							LipidFragmentInformationLevelType.MOLECULAR_FORMULA, "C2H5N"), //
					new LipidFragmentationRule(PolarityType.POSITIVE, IonizationType.SODIUM,
							LipidFragmentationRuleType.HEADGROUP_FRAGMENT_NL,
							LipidFragmentInformationLevelType.MOLECULAR_FORMULA, "C2H8NO4P"), //
					...
					new LipidFragmentationRule(PolarityType.NEGATIVE, IonizationType.NEGATIVE_HYDROGEN,
							LipidFragmentationRuleType.HEADGROUP_FRAGMENT,
							LipidFragmentInformationLevelType.MOLECULAR_FORMULA, "C5H11NO5P"), //
					new LipidFragmentationRule(PolarityType.NEGATIVE, IonizationType.NEGATIVE_HYDROGEN,
							LipidFragmentationRuleType.ACYLCHAIN_FRAGMENT,
							LipidFragmentInformationLevelType.CHAIN_COMPOSITION) }), //
	DIALKYLGLYCEROPHOSPHOETHANOLAMINES("Dialkylglycerophosphoethanolamines", "PE",
			LipidCoreClasses.GLYCEROPHOSPHOLIPIDS, LipidMainClasses.GLYCEROPHOSPHOETHANOLAMINES, "C5H14O6PN",
			new LipidChainType[] { LipidChainType.ALKYL_CHAIN, LipidChainType.ALKYL_CHAIN },
			new LipidFragmentationRule[] { //
			}), //
	ALKYLACYLGLYCEROPHOSPHOETHANOLAMINES("Alkylacylglycerophosphoethanolamines", "PE",
			...
			new LipidFragmentationRule[] { //
					...
					new LipidFragmentationRule(PolarityType.NEGATIVE, IonizationType.NEGATIVE_HYDROGEN,
							LipidFragmentationRuleType.ACYLCHAIN_MINUS_FORMULA_FRAGMENT_NL,
							LipidFragmentInformationLevelType.CHAIN_COMPOSITION, "OH"), //
					new LipidFragmentationRule(PolarityType.NEGATIVE, IonizationType.NEGATIVE_HYDROGEN,
							LipidFragmentationRuleType.ACYLCHAIN_FRAGMENT,
							LipidFragmentInformationLevelType.CHAIN_COMPOSITION) }), //
	...
	DIACYLGLYCEROPHOSPHOSERINES("Diacylglycerophosphoserines", "PS", LipidCoreClasses.GLYCEROPHOSPHOLIPIDS,
			LipidMainClasses.GLYCEROPHOSPHOSERINES, "C6H14O8NP",
			new LipidChainType[] { LipidChainType.ACYL_CHAIN, LipidChainType.ACYL_CHAIN },
			new LipidFragmentationRule[] { //
					new LipidFragmentationRule(PolarityType.POSITIVE, IonizationType.POSITIVE_HYDROGEN,
							LipidFragmentationRuleType.HEADGROUP_FRAGMENT_NL,
							LipidFragmentInformationLevelType.MOLECULAR_FORMULA, "C3H8NO6P"), //
					new LipidFragmentationRule(PolarityType.POSITIVE, IonizationType.POSITIVE_HYDROGEN,
							LipidFragmentationRuleType.ACYLCHAIN_FRAGMENT_NL,
							LipidFragmentInformationLevelType.CHAIN_COMPOSITION), //
					new LipidFragmentationRule(PolarityType.POSITIVE, IonizationType.POSITIVE_HYDROGEN,
					...
					new LipidFragmentationRule(PolarityType.POSITIVE, IonizationType.SODIUM,
							LipidFragmentationRuleType.HEADGROUP_FRAGMENT,
							LipidFragmentInformationLevelType.MOLECULAR_FORMULA, "C3H8NO6PNa"), //
					new LipidFragmentationRule(PolarityType.POSITIVE, IonizationType.SODIUM,
							LipidFragmentationRuleType.HEADGROUP_FRAGMENT_NL,
							LipidFragmentInformationLevelType.MOLECULAR_FORMULA, "H3PO4"), //

					new LipidFragmentationRule(PolarityType.NEGATIVE, IonizationType.NEGATIVE_HYDROGEN,
							LipidFragmentationRuleType.HEADGROUP_FRAGMENT,
							LipidFragmentInformationLevelType.MOLECULAR_FORMULA, "C3H6O5P"), //
					new LipidFragmentationRule(PolarityType.NEGATIVE, IonizationType.NEGATIVE_HYDROGEN,
							LipidFragmentationRuleType.HEADGROUP_FRAGMENT,
							LipidFragmentInformationLevelType.MOLECULAR_FORMULA, "H2PO4"), //
					new LipidFragmentationRule(PolarityType.NEGATIVE, IonizationType.NEGATIVE_HYDROGEN,
							LipidFragmentationRuleType.HEADGROUP_FRAGMENT,
							LipidFragmentInformationLevelType.MOLECULAR_FORMULA, "PO3"), //
					new LipidFragmentationRule(PolarityType.NEGATIVE, IonizationType.NEGATIVE_HYDROGEN,
							LipidFragmentationRuleType.HEADGROUP_FRAGMENT_NL,
							LipidFragmentInformationLevelType.MOLECULAR_FORMULA, "C3H5NO2"), //
					new LipidFragmentationRule(PolarityType.NEGATIVE, IonizationType.NEGATIVE_HYDROGEN,
							LipidFragmentationRuleType.ACYLCHAIN_FRAGMENT,
							LipidFragmentInformationLevelType.CHAIN_COMPOSITION) }), //
	DIALKYLGLYCEROPHOSPHOSERINES("Dialkylglycerophosphoserines", "PS", LipidCoreClasses.GLYCEROPHOSPHOLIPIDS,
			LipidMainClasses.GLYCEROPHOSPHOSERINES, "C6H14O8NP",
			new LipidChainType[] { LipidChainType.ALKYL_CHAIN, LipidChainType.ALKYL_CHAIN },
			new LipidFragmentationRule[] { //
			}), //
	ALKYLACYLGLYCEROPHOSPHOSERINES("Alkylacylglycerophosphoserines", "PS", LipidCoreClasses.GLYCEROPHOSPHOLIPIDS,
			LipidMainClasses.GLYCEROPHOSPHOSERINES, "C6H14O8NP",
			new LipidChainType[] { LipidChainType.ALKYL_CHAIN, LipidChainType.ACYL_CHAIN },
			new LipidFragmentationRule[] { //
					new LipidFragmentationRule(PolarityType.NEGATIVE, IonizationType.NEGATIVE_HYDROGEN,
							LipidFragmentationRuleType.ACYLCHAIN_MINUS_FORMULA_FRAGMENT_NL,
							LipidFragmentInformationLevelType.CHAIN_COMPOSITION, "C3H6O5P"), //
					new LipidFragmentationRule(PolarityType.NEGATIVE, IonizationType.NEGATIVE_HYDROGEN,
							LipidFragmentationRuleType.HEADGROUP_FRAGMENT_NL,
							LipidFragmentInformationLevelType.MOLECULAR_FORMULA, "C3H5NO2"), //
					new LipidFragmentationRule(PolarityType.NEGATIVE, IonizationType.NEGATIVE_HYDROGEN,
							LipidFragmentationRuleType.ACYLCHAIN_FRAGMENT,
							LipidFragmentInformationLevelType.CHAIN_COMPOSITION) }), //
	MONOACYLGLYCEROPHOSPHOSERINES("Monoacylglycerophosphoserines", "LPS", LipidCoreClasses.GLYCEROPHOSPHOLIPIDS,
			LipidMainClasses.GLYCEROPHOSPHOSERINES, "C6H14O8NP", new LipidChainType[] { LipidChainType.ACYL_CHAIN },
			new LipidFragmentationRule[] { //
			}), //
	MONOALKYLGLYCEROPHOSPHOSERINES("Monoalkylglycerophosphoserines", "LPS", LipidCoreClasses.GLYCEROPHOSPHOLIPIDS,
			LipidMainClasses.GLYCEROPHOSPHOSERINES, "C6H14O8NP", new LipidChainType[] { LipidChainType.ALKYL_CHAIN },
			new LipidFragmentationRule[] { //
			}), //
	DIACYLGLYCEROPHOSPHOGLYCEROLS("Diacylglycerophosphoglycerols", "PG", LipidCoreClasses.GLYCEROPHOSPHOLIPIDS,
			LipidMainClasses.GLYCEROPHOSPHOGLYCEROLS, "C6H15O8P",
			new LipidChainType[] { LipidChainType.ACYL_CHAIN, LipidChainType.ACYL_CHAIN },
			new LipidFragmentationRule[] { //
					new LipidFragmentationRule(PolarityType.POSITIVE, IonizationType.AMMONIUM,
							LipidFragmentationRuleType.HEADGROUP_FRAGMENT_NL,
							LipidFragmentInformationLevelType.MOLECULAR_FORMULA, "C3H12O6PN"), //

					new LipidFragmentationRule(PolarityType.NEGATIVE, IonizationType.NEGATIVE_HYDROGEN,
							LipidFragmentationRuleType.HEADGROUP_FRAGMENT,
							LipidFragmentInformationLevelType.MOLECULAR_FORMULA, "C6H14O8P"), //
					new LipidFragmentationRule(PolarityType.NEGATIVE, IonizationType.NEGATIVE_HYDROGEN,
							LipidFragmentationRuleType.HEADGROUP_FRAGMENT,
							LipidFragmentInformationLevelType.MOLECULAR_FORMULA, "C3H6O5P"), //
					new LipidFragmentationRule(PolarityType.NEGATIVE, IonizationType.NEGATIVE_HYDROGEN,
					...
					new LipidFragmentationRule(PolarityType.NEGATIVE, IonizationType.NEGATIVE_HYDROGEN,
							LipidFragmentationRuleType.ACYLCHAIN_FRAGMENT_NL,
							LipidFragmentInformationLevelType.CHAIN_COMPOSITION) }), //
	DIALKYLGLYCEROPHOSPHOGLYCEROLS("Dialkylglycerophosphoglycerols", "PG", LipidCoreClasses.GLYCEROPHOSPHOLIPIDS,
			LipidMainClasses.GLYCEROPHOSPHOGLYCEROLS, "C6H15O8P",
			new LipidChainType[] { LipidChainType.ALKYL_CHAIN, LipidChainType.ALKYL_CHAIN },
			new LipidFragmentationRule[] { //
			}), //
	ALKYLACYLGLYCEROPHOSPHOGLYCEROLS("Alkylacylglycerophosphoglycerols", "PG", LipidCoreClasses.GLYCEROPHOSPHOLIPIDS,
			LipidMainClasses.GLYCEROPHOSPHOGLYCEROLS, "C6H15O8P",
			new LipidChainType[] { LipidChainType.ALKYL_CHAIN, LipidChainType.ACYL_CHAIN },
			new LipidFragmentationRule[] { //
					new LipidFragmentationRule(PolarityType.POSITIVE, IonizationType.AMMONIUM,
					...
					new LipidFragmentationRule(PolarityType.NEGATIVE, IonizationType.NEGATIVE_HYDROGEN,
							LipidFragmentationRuleType.ACYLCHAIN_FRAGMENT_NL,
							LipidFragmentInformationLevelType.CHAIN_COMPOSITION) }), //
	MONOACYLGLYCEROPHOSPHOGLYCEROLS("Monoacylglycerophosphoglycerols", "LPG", LipidCoreClasses.GLYCEROPHOSPHOLIPIDS,
			LipidMainClasses.GLYCEROPHOSPHOGLYCEROLS, "C6H15O8P", new LipidChainType[] { LipidChainType.ACYL_CHAIN },
			new LipidFragmentationRule[] { //
					new LipidFragmentationRule(PolarityType.NEGATIVE, IonizationType.NEGATIVE_HYDROGEN,
							LipidFragmentationRuleType.HEADGROUP_FRAGMENT,
							LipidFragmentInformationLevelType.MOLECULAR_FORMULA, "C3H6O5P") }), //
	MONOALKYLGLYCEROPHOSPHOGLYCEROLS("Monoalkylglycerophosphoglycerols", "LPG", LipidCoreClasses.GLYCEROPHOSPHOLIPIDS,
			LipidMainClasses.GLYCEROPHOSPHOGLYCEROLS, "C6H15O8P", new LipidChainType[] { LipidChainType.ALKYL_CHAIN },
			new LipidFragmentationRule[] { //
					new LipidFragmentationRule(PolarityType.NEGATIVE, IonizationType.NEGATIVE_HYDROGEN,
							LipidFragmentationRuleType.HEADGROUP_FRAGMENT,
							LipidFragmentInformationLevelType.MOLECULAR_FORMULA, "C3H6O5P") }), //
	DIACYLGLYCEROPHOSPHOINOSITOLS("Diacylglycerophosphoinositols", "PI", LipidCoreClasses.GLYCEROPHOSPHOLIPIDS,
			LipidMainClasses.GLYCEROPHOSPHOINOSITOLS, "C9H19PO11",
			new LipidChainType[] { LipidChainType.ACYL_CHAIN, LipidChainType.ACYL_CHAIN },
			new LipidFragmentationRule[] { //
					new LipidFragmentationRule(PolarityType.POSITIVE, IonizationType.AMMONIUM,
							LipidFragmentationRuleType.HEADGROUP_FRAGMENT_NL,
							LipidFragmentInformationLevelType.MOLECULAR_FORMULA, "C6H17O9PN"), //
					new LipidFragmentationRule(PolarityType.POSITIVE, IonizationType.SODIUM,
							LipidFragmentationRuleType.HEADGROUP_FRAGMENT_NL,
							LipidFragmentInformationLevelType.MOLECULAR_FORMULA, "C6H13O9PNa"), //
					new LipidFragmentationRule(PolarityType.POSITIVE, IonizationType.SODIUM,
							LipidFragmentationRuleType.HEADGROUP_FRAGMENT,
							LipidFragmentInformationLevelType.MOLECULAR_FORMULA, "C6H13O9PNa"), //
					...
					new LipidFragmentationRule(PolarityType.NEGATIVE, IonizationType.NEGATIVE_HYDROGEN,
							LipidFragmentationRuleType.HEADGROUP_FRAGMENT,
							LipidFragmentInformationLevelType.MOLECULAR_FORMULA, "C6H10O8P"), //
					new LipidFragmentationRule(PolarityType.NEGATIVE, IonizationType.NEGATIVE_HYDROGEN,
							LipidFragmentationRuleType.ACYLCHAIN_FRAGMENT,
							LipidFragmentInformationLevelType.CHAIN_COMPOSITION), //
					new LipidFragmentationRule(PolarityType.NEGATIVE, IonizationType.NEGATIVE_HYDROGEN,
							LipidFragmentationRuleType.ACYLCHAIN_FRAGMENT_NL,
							LipidFragmentInformationLevelType.CHAIN_COMPOSITION) }), //
	DIALKYLGLYCEROPHOSPHOINOSITOLS("Dialkylglycerophosphoinositols", "PI", LipidCoreClasses.GLYCEROPHOSPHOLIPIDS,
			LipidMainClasses.GLYCEROPHOSPHOINOSITOLS, "C9H19PO11",
			new LipidChainType[] { LipidChainType.ALKYL_CHAIN, LipidChainType.ALKYL_CHAIN },
			new LipidFragmentationRule[] { //
			}), //
	ALKYLACYLGLYCEROPHOSPHOINOSITOLS("Alkylacylglycerophosphoinositols", "PI", LipidCoreClasses.GLYCEROPHOSPHOLIPIDS,
			LipidMainClasses.GLYCEROPHOSPHOINOSITOLS, "C9H19PO11",
			new LipidChainType[] { LipidChainType.ALKYL_CHAIN, LipidChainType.ACYL_CHAIN },
			new LipidFragmentationRule[] { //
					new LipidFragmentationRule(PolarityType.NEGATIVE, IonizationType.NEGATIVE_HYDROGEN,
					...
					new LipidFragmentationRule(PolarityType.NEGATIVE, IonizationType.NEGATIVE_HYDROGEN,
							...
							LipidFragmentInformationLevelType.CHAIN_COMPOSITION, "C3H5O4P") }), //
	MONOACYLGLYCEROPHOSPHOINOSITOLS("Monoacylglycerophosphoinositols", "LPI", LipidCoreClasses.GLYCEROPHOSPHOLIPIDS,
			LipidMainClasses.GLYCEROPHOSPHOINOSITOLS, "C9H19PO11", new LipidChainType[] { LipidChainType.ACYL_CHAIN },
			new LipidFragmentationRule[] { //
					new LipidFragmentationRule(PolarityType.NEGATIVE, IonizationType.NEGATIVE_HYDROGEN,
							LipidFragmentationRuleType.HEADGROUP_FRAGMENT,
							LipidFragmentInformationLevelType.MOLECULAR_FORMULA, "C6H10O8P"), //
					...
					new LipidFragmentationRule(PolarityType.NEGATIVE, IonizationType.NEGATIVE_HYDROGEN,
							LipidFragmentationRuleType.ALKYLCHAIN_MINUS_FORMULA_FRAGMENT,
							LipidFragmentInformationLevelType.CHAIN_COMPOSITION, "C3H5O4P") }), //
	MONOALKYLGLYCEROPHOSPHOINOSITOLS("Monoalkylglycerophosphoinositols", "LPI", LipidCoreClasses.GLYCEROPHOSPHOLIPIDS,
			LipidMainClasses.GLYCEROPHOSPHOINOSITOLS, "C9H19PO11", new LipidChainType[] { LipidChainType.ALKYL_CHAIN },
			new LipidFragmentationRule[] { //
					new LipidFragmentationRule(PolarityType.NEGATIVE, IonizationType.NEGATIVE_HYDROGEN,
							LipidFragmentationRuleType.HEADGROUP_FRAGMENT,
							LipidFragmentInformationLevelType.MOLECULAR_FORMULA, "C6H10O8P"), //
	...
	ALKYLACYLGLYCEROPHOSPHATES("Alkylacylglycerophosphates", "PA", LipidCoreClasses.GLYCEROPHOSPHOLIPIDS,
			LipidMainClasses.GLYCEROPHOSPHATES, "C3H9O6P",
			new LipidChainType[] { LipidChainType.ALKYL_CHAIN, LipidChainType.ACYL_CHAIN },
			new LipidFragmentationRule[] { //
			}), //
	MONOACYLGLYCEROPHOSPHATES("Monoacylglycerophosphates", "LPA", LipidCoreClasses.GLYCEROPHOSPHOLIPIDS,
			LipidMainClasses.GLYCEROPHOSPHATES, "C3H9O6P", new LipidChainType[] { LipidChainType.ACYL_CHAIN },
			new LipidFragmentationRule[] { //
					new LipidFragmentationRule(PolarityType.NEGATIVE, IonizationType.NEGATIVE_HYDROGEN,
							LipidFragmentationRuleType.HEADGROUP_FRAGMENT,
							LipidFragmentInformationLevelType.MOLECULAR_FORMULA, "C3H6O5P"), //
			}), //
	MONOALKYLGLYCEROPHOSPHATES("Monoalkylglycerophosphates", "LPA", LipidCoreClasses.GLYCEROPHOSPHOLIPIDS,
			LipidMainClasses.GLYCEROPHOSPHATES, "C3H9O6P", new LipidChainType[] { LipidChainType.ALKYL_CHAIN },
			new LipidFragmentationRule[] { //
					new LipidFragmentationRule(PolarityType.NEGATIVE, IonizationType.NEGATIVE_HYDROGEN,
							LipidFragmentationRuleType.HEADGROUP_FRAGMENT,
							LipidFragmentInformationLevelType.MOLECULAR_FORMULA, "C3H6O5P"), //
			}), //
	DIACYLGLYCEROPHOSPHOGLYCEROPHOSPHODIRADYLGLYCEROLS("Diacylglycerophosphoglycerophosphodiradylglycerols", "CL",
			LipidCoreClasses.GLYCEROPHOSPHOLIPIDS, LipidMainClasses.CARDIOLIPIN,
			"C9H22O13P2",
			new LipidChainType[] { LipidChainType.ACYL_CHAIN, LipidChainType.ACYL_CHAIN, LipidChainType.ACYL_CHAIN,
	...
	LipidClasses(String name, String abbr, LipidCoreClasses coreClass, LipidMainClasses mainClass,
			String backBoneFormula, LipidChainType[] chainTypes, LipidFragmentationRule[] fragmentationRules) {
		this.name = name;
		this.abbr = abbr;
