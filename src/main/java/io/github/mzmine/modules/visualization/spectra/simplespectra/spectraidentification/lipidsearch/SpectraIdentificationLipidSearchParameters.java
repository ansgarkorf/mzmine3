...
public class SpectraIdentificationLipidSearchParameters extends SimpleParameterSet {
	...
	public static final IntRangeParameter doubleBonds = new IntRangeParameter("Number of double bonds in chains",
			"Number of double bonds in chains");
	...
	public static final MZToleranceParameter mzTolerance = new MZToleranceParameter("m/z tolerance MS1 level:",
			"Enter m/z tolerance for exact mass database matching on MS1 level");

	public static final OptionalModuleParameter<LipidSpeactraSearchMSMSParameters> searchForMSMSFragments = new OptionalModuleParameter<LipidSpeactraSearchMSMSParameters>(
			"Search for lipid class specific fragments in MS/MS spectra",
			"Search for lipid class specific fragments in MS/MS spectra", new LipidSpeactraSearchMSMSParameters());
	...
	public SpectraIdentificationLipidSearchParameters() {
		super(new Parameter[] { massList, lipidClasses, chainLength, doubleBonds, ionizationMethod, mzTolerance,
